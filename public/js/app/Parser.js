...
yy: {},
symbols_: {"error":2,"expressions":3,"instruction":4,"EOF":5,"R_TYPE":6,"REG":7,",":8,"R_TYPEF":9,"I_TYPE":10,"OFFSET":11,"(":12,")":13,"I_TYPE_B":14,"I_TYPEF":15,"J_TYPE":16,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",6:"R_TYPE",7:"REG",8:",",9:"R_TYPEF",10:"I_TYPE",11:"OFFSET",12:"(",13:")",14:"I_TYPE_B",15:"I_TYPEF",16:"J_TYPE"},
productions_: [0,[3,2],[4,6],[4,6],[4,7],[4,6],[4,7],[4,2]],
...
case 5:
  var instructionId = "s" + instructionCounter,
  string = $$.join(" "),
  ItypeB = new Instruction(instructionId, $$[$0], [$$[$0-4], $$[$0-2]], string, "beq_type" );

  stack.addInstruction(ItypeB);
...
case 7:
  var instructionId = "s" + instructionCounter,
  string = $$.join(" "),
  Jtype = new Instruction(instructionId, $$[$0], [], string, 'jump');

  stack.addInstruction(Jtype);

  instructionCounter++;
break;
}
},
table: [{3:1,4:2,6:[1,3],9:[1,4],10:[1,5],14:[1,6],15:[1,7],16:[1,8]},{1:[3]},{5:[1,9]},{7:[1,10]},{7:[1,11]},{7:[1,12]},{7:[1,13]},{7:[1,14]},{11:[1,15]},{1:[2,1]},{8:[1,16]},{8:[1,17]},{8:[1,18]},{8:[1,19]},{8:[1,20]},{5:[2,7]},{7:[1,21]},{7:[1,22]},{11:[1,23]},{7:[1,24]},{11:[1,25]},{8:[1,26]},{8:[1,27]},{12:[1,28]},{8:[1,29]},{12:[1,30]},{7:[1,31]},{7:[1,32]},{7:[1,33]},{11:[1,34]},{7:[1,35]},{5:[2,2]},{5:[2,3]},{13:[1,36]},{5:[2,5]},{13:[1,37]},{5:[2,4]},{5:[2,6]}],
defaultActions: {9:[2,1],15:[2,7],31:[2,2],32:[2,3],34:[2,5],36:[2,4],37:[2,6]},
...
rules: [/^(?:[ \t\r\n\s])/,/^(?:((?:\$t|[rR])(?:[12]?[0-9]|3[01]))\b|(\$zero))/,/^(?:-?[0-9]\d*)/,/^(?:\()/,/^(?:\))/,/^(?:,)/,/^(?:ADDF|SUBF|MULF|DIVF\b)/,/^(?:addf|subf|subf|divf\b)/,/^(?:LF|SF\b)/,/^(?:lf|sf\b)/,/^(?:ADD|SUB|MUL|DIV\b)/,/^(?:add|sub|mul|div\b)/,/^(?:LW|SW\b)/,/^(?:lw|sw\b)/,/^(?:BEQ|beq\b)/,/^(?:JUMP|jump\b)/,/^(?:$)/,/^(?:.)/],
